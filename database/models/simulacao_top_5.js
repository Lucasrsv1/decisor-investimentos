...
class SimulacaoTop5 extends Model {
	/**
 ...
 * @returns
 */
function initSimulacaoTop5 (sequelize) {
	SimulacaoTop5.init({
		id: {
		...
		sequelize,
		timestamps: false,
		modelName: "SimulacaoTop5",
		tableName: "simulacao_top_5",
		underscored: true
	});

	return SimulacaoTop5;
}

module.exports = { initSimulacaoTop5 };
